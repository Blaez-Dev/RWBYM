package io.github.blaezdev.rwbym.gui.scroll;
...
import io.github.blaezdev.rwbym.utility.network.MessagePlayerEXP;
import io.github.blaezdev.rwbym.utility.network.MessageSendPlayerDataToServer;
...
public class GuiScreenScrollLevel extends GuiScreen {
	...
	public void updateScreen() {
		...
		if (aura != null) {
			...
			if(2147000000>aura.getEXPToLevel()){this.button1.displayString = "Lvl Aura: " + aura.getEXPToLevel();}
			else{this.button1.displayString = "Aura Level Maxed";};
