...
public class EnchantmentFluted extends Enchantment {
    public EnchantmentFluted(){
        ...
        this.setName("flutedbarrel");
        this.setRegistryName(new ResourceLocation(RWBYModels.MODID+":flutedbarrel"));
