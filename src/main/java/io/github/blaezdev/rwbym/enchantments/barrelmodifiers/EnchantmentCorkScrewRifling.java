...
public class EnchantmentCorkScrewRifling extends Enchantment {
    public EnchantmentCorkScrewRifling(){
        ...
        this.setName("corkscrewrifling");
        this.setRegistryName(new ResourceLocation(RWBYModels.MODID+":corkscrewrifling"));
    ...
    protected boolean canApplyTogether(Enchantment ench) {
        return super.canApplyTogether(ench)
                && ench != EnchantInit.ARROW_BREAK_BARREL && ench != EnchantInit.CHAMBERED_COMPENSATOR_BARREL && ench != EnchantInit.EXTENDED_BARREL && ench != EnchantInit.FLUTED_BARREL
