...
public class EnchantmentArrowBrake extends Enchantment {
    public EnchantmentArrowBrake(){
        ...
        this.setName("arrowbrake");
        this.setRegistryName(new ResourceLocation(RWBYModels.MODID+":arrowbrake"));
    ...
    protected boolean canApplyTogether(Enchantment ench) {
        return super.canApplyTogether(ench)
                && ench != EnchantInit.CHAMBERED_COMPENSATOR_BARREL && ench != EnchantInit.CORKSCREW_RIFLING && ench != EnchantInit.EXTENDED_BARREL && ench != EnchantInit.FLUTED_BARREL
