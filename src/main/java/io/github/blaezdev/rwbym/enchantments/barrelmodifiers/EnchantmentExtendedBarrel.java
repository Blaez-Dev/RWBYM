...
public class EnchantmentExtendedBarrel extends Enchantment {
    public EnchantmentExtendedBarrel(){
        ...
        this.setName("extendedbarrel");
        this.setRegistryName(new ResourceLocation(RWBYModels.MODID+":extendedbarrel"));
    ...
    protected boolean canApplyTogether(Enchantment ench) {
        return super.canApplyTogether(ench)
                && ench != EnchantInit.ARROW_BREAK_BARREL && ench != EnchantInit.CORKSCREW_RIFLING && ench != EnchantInit.CHAMBERED_COMPENSATOR_BARREL && ench != EnchantInit.FLUTED_BARREL
