...
public class EnchantmentFullBore extends Enchantment {
    public EnchantmentFullBore(){
        ...
        this.setName("fullbore");
        this.setRegistryName(new ResourceLocation(RWBYModels.MODID+":fullbore"));
    ...
    protected boolean canApplyTogether(Enchantment ench) {
        return super.canApplyTogether(ench)
                ...
                && ench != EnchantInit.FLUTED_BARREL && ench != EnchantInit.HOME_FORGED_RIFILING && ench != EnchantInit.POLYGONAL_RIFILING && ench != EnchantInit.SMALL_BORE_BARREL;
    }
}
