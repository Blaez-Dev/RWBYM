...
public class EnchantmentPolygonalRifling extends Enchantment {
    public EnchantmentPolygonalRifling(){
        ...
        this.setName("polygonalrifling");
        this.setRegistryName(new ResourceLocation(RWBYModels.MODID+":polygonalrifling"));
    ...
    protected boolean canApplyTogether(Enchantment ench) {
        return super.canApplyTogether(ench)
                ...
                && ench != EnchantInit.FLUTED_BARREL && ench != EnchantInit.FULL_BORE_BARREL && ench != EnchantInit.HOME_FORGED_RIFILING && ench != EnchantInit.SMALL_BORE_BARREL;
    }
}