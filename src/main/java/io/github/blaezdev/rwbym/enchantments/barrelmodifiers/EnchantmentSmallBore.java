...
public class EnchantmentSmallBore extends Enchantment {
    public EnchantmentSmallBore(){
        ...
        this.setName("smallbore");
        this.setRegistryName(new ResourceLocation(RWBYModels.MODID+":smallbore"));
    ...
    protected boolean canApplyTogether(Enchantment ench) {
        return super.canApplyTogether(ench)
                ...
                && ench != EnchantInit.FLUTED_BARREL && ench != EnchantInit.FULL_BORE_BARREL && ench != EnchantInit.HOME_FORGED_RIFILING && ench != EnchantInit.POLYGONAL_RIFILING;
    }
}