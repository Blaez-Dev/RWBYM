...
public class PlayerRenderHandler {
	...
	public static class LayerGlider implements LayerRenderer<EntityLivingBase>
	{
	    /** The basic Elytra texture. */
	    private static final ResourceLocation TEXTURE_ELYTRA = new ResourceLocation(RWBYModels.MODID, "textures/entity/glider.png");
