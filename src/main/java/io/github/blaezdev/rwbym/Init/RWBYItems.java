...
public class RWBYItems {
    ...
    public static final Item crescentfrost = new RWBYGun(
            ...
            () -> Sound.CRESCENT_ROSE_SHOOT.getSound(),//1,
            null).setRecoil(5);
    public static final Item sunderaxe = new RWBYGun(
            "sunderaxe",
            2500,
            16,
            RWBYGun.SCYTHE,
    ...
    public static final Item ozpincane = new RWBYGun(
            ...
            null,
            null);
    public static final Item ozpincanetravel = new RWBYGun(
            "ozpincanetravel",
            2500,
            1,
            RWBYGun.SWORD,
    ...
    public static final Item crescentgunfrost = new RWBYGun(
            ...
            () -> Sound.CRESCENT_ROSE_SHOOT.getSound(),//1,
            null).setRecoil(10);
    public static final Item sunderrifle = new RWBYGun(
            "sunderrifle",
            2500,
            0,
            0,
