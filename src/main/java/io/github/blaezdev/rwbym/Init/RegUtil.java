...
public class RegUtil {
    public static void registerAll(FMLPreInitializationEvent event){
        ...
        registerItems(event, RWBYItems.whisperingblossom);
        registerItems(event, RWBYItems.pugzsword);
        registerItems(event, RWBYItems.pugzbow);
        registerItems(event, RWBYItems.cassandra);
        registerItems(event, RWBYItems.cassandragun);
        registerItems(event, RWBYItems.whisperammo);
        registerItems(event, RWBYItems.whisperingblossomammo);
        ...
        registerItems(event, RWBYItems.amesardent);
        registerItems(event, RWBYItems.amesardentgun);
        ...
        registerItems(event, RWBYItems.antlerlarge);
        registerItems(event, RWBYItems.antlersmall);
        registerItems(event, RWBYItems.blackbullhorns);
        registerItems(event, RWBYItems.blackfoxtail);
        registerItems(event, RWBYItems.blackwolfears);
        registerItems(event, RWBYItems.blackwolftail);
        registerItems(event, RWBYItems.blondefoxtail);
        registerItems(event, RWBYItems.blondewolfears);
        registerItems(event, RWBYItems.blondewolftail);
        registerItems(event, RWBYItems.bluedragontail);
        registerItems(event, RWBYItems.whitefoxear);
        registerItems(event, RWBYItems.blackdragontail);
        registerItems(event, RWBYItems.bonebullhorns);
        registerItems(event, RWBYItems.brownfoxtail);
        registerItems(event, RWBYItems.brownwolfears);
        registerItems(event, RWBYItems.brownwolftail);
        registerItems(event, RWBYItems.golddragontail);
        registerItems(event, RWBYItems.grayfoxtail);
        registerItems(event, RWBYItems.graywolfears);
        registerItems(event, RWBYItems.graywolftail);
        registerItems(event, RWBYItems.greendragontail);
        registerItems(event, RWBYItems.orangefoxtail);
        registerItems(event, RWBYItems.orangewolfears);
        registerItems(event, RWBYItems.orangewolftail);
        registerItems(event, RWBYItems.ramhorns);
        registerItems(event, RWBYItems.reddragontail);
        registerItems(event, RWBYItems.silverdragontail);
        registerItems(event, RWBYItems.whitedragontail);
        registerItems(event, RWBYItems.whitefoxtail);
        registerItems(event, RWBYItems.whitewolfears);
        registerItems(event, RWBYItems.whitewolftail);
        ...
        registerItems(event, RWBYItems.henchmenhat);
        registerItems(event, RWBYItems.henchmenhatglasses);
        ...
        registerItems(event, RWBYItems.adamv6Chest);
        registerItems(event, RWBYItems.adamv6Legs);
        registerItems(event, RWBYItems.neoChest);
        registerItems(event, RWBYItems.neoLegs);
        registerItems(event, RWBYItems.oscarv4Chest);
        registerItems(event, RWBYItems.oscarv4Legs);
        registerItems(event, RWBYItems.oscarv6Chest);
        registerItems(event, RWBYItems.oscarv6Legs);
        registerItems(event, RWBYItems.ozma1Chest);
        registerItems(event, RWBYItems.ozma1Legs);
        registerItems(event, RWBYItems.ozma2Chest);
        registerItems(event, RWBYItems.ozma2Legs);
        registerItems(event, RWBYItems.ozma3Chest);
        registerItems(event, RWBYItems.ozma3Legs);
        registerItems(event, RWBYItems.pennyv7Chest);
        registerItems(event, RWBYItems.pennyv7Legs);
    ...
    public static void registerAllRecipes(FMLInitializationEvent event){
        //Recipes
        registerRecipes(RWBYItems.cassandragun);
        registerRecipes(RWBYItems.cassandra);
        registerRecipes(RWBYItems.onoyari);
        registerRecipes(RWBYItems.pugzbow);
        registerRecipes(RWBYItems.pugzsword);
        registerRecipes(RWBYItems.whisperingblossom);
