...
public class RegUtil {
    public static void registerAll(FMLPreInitializationEvent event){
        ...
        registerBlocks(event, RWBYItems.lantern);
        //weapons
        ...
        registerItems(event, RWBYItems.coin_valour);
        ...
        registerItems(event, RWBYItems.AtlasredHead);
        registerItems(event, RWBYItems.AtlasredChest);
        registerItems(event, RWBYItems.AtlasredLegs);
        registerItems(event, RWBYItems.AtlasyellowHead);
        registerItems(event, RWBYItems.AtlasyellowChest);
        registerItems(event, RWBYItems.AtlasyellowLegs);
        registerItems(event, RWBYItems.AtlasgreenHead);
        registerItems(event, RWBYItems.AtlasgreenChest);
        registerItems(event, RWBYItems.AtlasgreenLegs);
    ...
    public static void registerAllRecipes(FMLInitializationEvent event){
        ...
        registerRecipes( RWBYItems.AtlasyellowHead);
        registerRecipes( RWBYItems.AtlasyellowChest);
        registerRecipes( RWBYItems.AtlasyellowLegs);
        registerRecipes( RWBYItems.AtlasredHead);
        registerRecipes( RWBYItems.AtlasredChest);
        registerRecipes( RWBYItems.AtlasredLegs);
        registerRecipes( RWBYItems.AtlasgreenHead);
        registerRecipes( RWBYItems.AtlasgreenChest);
        registerRecipes( RWBYItems.AtlasgreenLegs);
