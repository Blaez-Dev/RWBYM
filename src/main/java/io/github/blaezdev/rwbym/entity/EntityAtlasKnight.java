...
public class EntityAtlasKnight extends EntityGolem {
     ...
     protected boolean canDespawn() {
        ...
        protected void applyEntityAttributes() {
            ...
            this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(100.0D*RWBYConfig.attributes.grimmhealthmult);
     ...
     public boolean attackEntityAsMob(Entity entityIn)
     {
         ...
         boolean flag = entityIn.attackEntityFrom(DamageSource.causeMobDamage(this), (float)(9 + this.rand.nextInt(15)* RWBYConfig.attributes.grimmattackmult));
