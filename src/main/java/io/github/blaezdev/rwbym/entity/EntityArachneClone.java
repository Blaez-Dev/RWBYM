...
public class EntityArachneClone extends EntityGrimm {
    World world = null;
    private EntityLiving owner;
    @Nullable

    public EntityArachneClone(World var1) {
        super(var1);
        world = var1;
    ...
    protected void initEntityAI() {
        ...
        this.targetTasks.addTask(2, new EntityArachneClone.AICopyOwnerTarget(this));
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(1.0D*RWBYConfig.attributes.grimmhealthmult);
    ...
    class AICopyOwnerTarget extends EntityAITarget
    {
        ...
        {
            return EntityArachneClone.this.owner != null && EntityArachneClone.this.owner.getAttackTarget() != null && this.isSuitableTarget(EntityArachneClone.this.owner.getAttackTarget(), false);
        }
        ...
        {
            EntityArachneClone.this.setAttackTarget(EntityArachneClone.this.owner.getAttackTarget());
