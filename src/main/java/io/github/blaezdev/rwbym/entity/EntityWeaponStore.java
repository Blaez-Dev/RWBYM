...
public class EntityWeaponStore extends EntityRWBYMMerchant implements INpc, IMerchant{
    ...
    private MerchantRecipe[] weapons = new MerchantRecipe[]{
            ...
            new MerchantRecipe(new ItemStack(RWBYItems.lien500,4),generateitem(new ItemStack(RWBYItems.atlasrifle,1))),
            ...
            new MerchantRecipe(new ItemStack(RWBYItems.lien500,8),new ItemStack(RWBYItems.roseiron,8), generateitem(new ItemStack(RWBYItems.lucidroseboard, 1))),
