...
public class EntityHollow extends EntityGrimm {
    World world = null;
    private int cooldown = 0;

    public EntityHollow(World var3) {
        super(var3);
        world = var3;
    ...
    public void onLivingUpdate() {
        ...
        AxisAlignedBB axisalignedbb2 = this.getEntityBoundingBox().grow(5,5,5);
        ...
        {
            entityplayer.addPotionEffect(new PotionEffect(MobEffects.POISON, 120, 1, true, true));
            entityplayer.addPotionEffect(new PotionEffect(MobEffects.NAUSEA, 120, 0, true, true));
        }}
