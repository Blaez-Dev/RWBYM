...
public class EntitySeer extends EntityGrimm {
    World world = null;
    private EntityLiving owner;
    @Nullable

    public EntitySeer(World var1) {
        super(var1);
        world = var1;
        this.setSize(2F, 2F);
    }
    ...
    protected void initEntityAI() {
        ...
        this.targetTasks.addTask(2, new EntitySeer.AICopyOwnerTarget(this));
    ...
    class AICopyOwnerTarget extends EntityAITarget
    {
        ...
        {
            return EntitySeer.this.owner != null && EntitySeer.this.owner.getAttackTarget() != null && this.isSuitableTarget(EntitySeer.this.owner.getAttackTarget(), false);
        }
        ...
        {
            EntitySeer.this.setAttackTarget(EntitySeer.this.owner.getAttackTarget());
