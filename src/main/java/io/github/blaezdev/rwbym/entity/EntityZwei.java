...
public class EntityZwei extends EntityTameable
{
    ...
    public EntityZwei(World worldIn)
    {
        super(worldIn);
    ...
    protected void initEntityAI()
    {
        ...
        this.tasks.addTask(3, new EntityZwei.AIAvoidEntity(this, EntityLlama.class, 24.0F, 1.5D, 1.5D));
    ...
    public EntityZwei createChild(EntityAgeable ageable)
    {
        EntityZwei EntityZwei = new EntityZwei(this.world);
        UUID uuid = this.getOwnerId();

        if (uuid != null)
        {
            EntityZwei.setOwnerId(uuid);
            EntityZwei.setTamed(true);
        }
  ...
  return false;
    ...
    public boolean shouldAttackEntity(EntityLivingBase target, EntityLivingBase owner)
    {
        ...
        {
            if (target instanceof EntityZwei)
            {
                EntityZwei EntityZwei = (EntityZwei)target;

                if (EntityZwei.isTamed() && EntityZwei.getOwner() == owner)
                {
                    return false;
                }
            }
    ...
    {
        private final EntityZwei wolf;

        public AIAvoidEntity(EntityZwei wolfIn, Class<T> p_i47251_3_, float p_i47251_4_, double p_i47251_5_, double p_i47251_7_)
        {
        ...
        {
            return p_190854_1_.getStrength() >= EntityZwei.this.rand.nextInt(5);
        }
        ...
        {
            EntityZwei.this.setAttackTarget((EntityLivingBase)null);
