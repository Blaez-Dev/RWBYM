...
public class EntityBlackStore extends EntityRWBYMMerchant implements INpc, IMerchant{
    ...
    protected void populateTradingList() {
        ...
        this.trades.add(new MerchantRecipe(new ItemStack(RWBYItems.lien500,1),new ItemStack(RWBYItems.hrdltfence,15)));
        this.trades.add(new MerchantRecipe(new ItemStack(RWBYItems.lien100,3),new ItemStack(RWBYItems.lantern,32)));
