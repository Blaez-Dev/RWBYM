...
public class ComponentVillageShop2 extends StructureVillagePieces.Village {
    private static final ResourceLocation shop = new ResourceLocation("rwbym:rwbym4");

    public ComponentVillageShop2() {
    }

    public ComponentVillageShop2(StructureVillagePieces.Start start, int type, StructureBoundingBox boundingBox, EnumFacing facing) {
        super(start, type);
    ...
    public static StructureVillagePieces.Village buildComponent(StructureVillagePieces.PieceWeight villagePiece, StructureVillagePieces.Start startPiece, List<StructureComponent> pieces, Random random, int x, int y, int z, EnumFacing facing, int type) {
        ...
        if (canVillageGoDeeper(boundingBox) && findIntersecting(pieces, boundingBox) == null) {
            return new ComponentVillageShop2(startPiece, type, boundingBox, facing);
        }
