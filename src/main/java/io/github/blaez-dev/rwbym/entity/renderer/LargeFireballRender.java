...
import io.github.blaez-dev.rwbym.entity.EntityLargeFireball;
...
public class LargeFireballRender extends Render<EntityLargeFireball> {
    public static Factory FACTORY = new Factory();
    private final float scale;

    public LargeFireballRender(RenderManager renderManagerIn, float scaleIn) {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityLargeFireball entity) {
        return TextureMap.LOCATION_BLOCKS_TEXTURE;
    }

    public static class Factory implements IRenderFactory<EntityLargeFireball> {

        @Override
        public Render<? super EntityLargeFireball> createRenderFor(RenderManager manager) {
            return new LargeFireballRender(manager, 1);
        }
