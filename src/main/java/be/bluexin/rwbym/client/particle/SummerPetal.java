...
public class SummerPetal extends Particle
{
    private final ResourceLocation summerpetalrl = new ResourceLocation("rwbym:entity/summerpetal");

    /**
     * Construct a new RosePetal at the given [x,y,z] position with the given initial velocity.
     */
    public SummerPetal(World world, double x, double y, double z,
                     double velocityX, double velocityY, double velocityZ)
    {
        ...
        TextureAtlasSprite sprite = Minecraft.getMinecraft().getTextureMapBlocks().getAtlasSprite(summerpetalrl.toString());
