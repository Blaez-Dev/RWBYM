...
public class EntityWinterBoarbatusk extends EntityMob {
    ...
    protected void initEntityAI() {
        ...
        this.targetTasks.addTask(2, new EntityWinterBoarbatusk.AICopyOwnerTarget(this));
    ...
    class AICopyOwnerTarget extends EntityAITarget
    {
        ...
        {
            return EntityWinterBoarbatusk.this.owner != null && EntityWinterBoarbatusk.this.owner.getAttackTarget() != null && this.isSuitableTarget(EntityWinterBoarbatusk.this.owner.getAttackTarget(), false);
        }
        ...
        {
            EntityWinterBoarbatusk.this.setAttackTarget(EntityWinterBoarbatusk.this.owner.getAttackTarget());
