...
public class EntityWinterUrsa extends EntityMob {
    ...
    public EntityWinterUrsa(World var1) {
        super(var1);
        world = var1;
        ...
        this.targetTasks.addTask(1, new EntityAINearestAttackableTarget(this, EntityLiving.class, 10, false, true, new Predicate<EntityLiving>()
                {
                    ...
                    {
                        return p_apply_1_ != null && IMob.VISIBLE_MOB_SELECTOR.apply(p_apply_1_) && !(p_apply_1_ instanceof EntityCreeper)&& !(p_apply_1_ instanceof EntityAtlasKnight) && !(p_apply_1_ instanceof EntityWinterBeowolf) && !(p_apply_1_ instanceof EntityWinterUrsa) && !(p_apply_1_ instanceof EntityWinterBoarbatusk);
                    }
                }
                )
