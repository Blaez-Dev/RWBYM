...
public class EntityArmourStore extends EntityCreature implements INpc, IMerchant{
    ...
    private static MerchantRecipe[] weapons = new MerchantRecipe[]{
            ...
            new MerchantRecipe(new ItemStack(RWBYItems.lien5,3), new ItemStack(RWBYItems.neptuneLegs, 1)),
            new MerchantRecipe(new ItemStack(RWBYItems.lien5,3), new ItemStack(RWBYItems.romanHead, 1)),
            new MerchantRecipe(new ItemStack(RWBYItems.lien5,3), new ItemStack(RWBYItems.romanChest, 1)),
            new MerchantRecipe(new ItemStack(RWBYItems.lien5,3), new ItemStack(RWBYItems.romanLegs, 1)),
            new MerchantRecipe(new ItemStack(RWBYItems.lien5,3), new ItemStack(RWBYItems.ironwood1Chest, 1)),
            new MerchantRecipe(new ItemStack(RWBYItems.lien5,3), new ItemStack(RWBYItems.ironwood1Legs, 1)),
            new MerchantRecipe(new ItemStack(RWBYItems.lien5,3), new ItemStack(RWBYItems.ironwood2Chest, 1)),
            new MerchantRecipe(new ItemStack(RWBYItems.lien5,3), new ItemStack(RWBYItems.ironwood2Legs, 1)),
            new MerchantRecipe(new ItemStack(RWBYItems.lien5,3), new ItemStack(RWBYItems.mercury1Chest, 1)),
            new MerchantRecipe(new ItemStack(RWBYItems.lien5,3), new ItemStack(RWBYItems.mercury1Legs, 1)),
            new MerchantRecipe(new ItemStack(RWBYItems.lien5,3), new ItemStack(RWBYItems.mercury2Chest, 1)),
            new MerchantRecipe(new ItemStack(RWBYItems.lien5,3), new ItemStack(RWBYItems.mercury2Legs, 1)),
            new MerchantRecipe(new ItemStack(RWBYItems.lien5,3), new ItemStack(RWBYItems.ozpinChest, 1)),
            new MerchantRecipe(new ItemStack(RWBYItems.lien5,3), new ItemStack(RWBYItems.ozpinLegs, 1)),
            new MerchantRecipe(new ItemStack(RWBYItems.lien5,3), new ItemStack(RWBYItems.sageChest, 1)),
            new MerchantRecipe(new ItemStack(RWBYItems.lien5,3), new ItemStack(RWBYItems.sageLegs, 1)),
            new MerchantRecipe(new ItemStack(RWBYItems.lien5,3), new ItemStack(RWBYItems.sunChest, 1)),
            new MerchantRecipe(new ItemStack(RWBYItems.lien5,3), new ItemStack(RWBYItems.sunLegs, 1)),
            new MerchantRecipe(new ItemStack(RWBYItems.lien5,3), new ItemStack(RWBYItems.scarletChest, 1)),
            new MerchantRecipe(new ItemStack(RWBYItems.lien5,3), new ItemStack(RWBYItems.scarletLegs, 1)),
