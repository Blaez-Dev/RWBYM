...
public class RWBYShotgun extends ItemBow implements ICustomItem {
    ...
    public RWBYShotgun(String name, int durability, int drawSpeed, int enchantability, String data, String morph, String ammo, boolean noCharge, float projectileSpeed, boolean usesAmmo, int bulletCount, int recoilType, int enchantmentglow, CreativeTabs creativetab) {
        ...
        if(name.contains("reesegun")) emerald = true;
        ...
        if(name.contains("sun")) port = true;
